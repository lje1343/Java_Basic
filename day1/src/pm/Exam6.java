...
//
//		타입 변환을 수행할 때는 저장할 수 있는 값의 범위나 종류가 달라지므로 값이 변화할 수 있다.
//		타입 변환에는 자바가 자동으로 수행하는 '자동 타입변환' 과 
//		개발자가 직접 변환을 수행해야하는 '수동 타입변환' 이 있다.
...
//		이유는 cpu에서 연산 최소 단위가 int이므로 int보다 작은 자료형은 일단 int로 읽어와서 
//		연산을 수행하기 때문이다.
...
//	}//7
		...
		//4 byte d = a+b; -> int
		//5 long e = 100;
		//6 float f = 3.5; -> double
		
		//Q3. 1-> 8.5 2->8 3->9 4->1 5->1.5 6->1.0
