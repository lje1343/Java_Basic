...
public class Exam5 {
	...
	public static void main(String[] args) {
		/*
		 ...
		 그 반대는 다운 캐스팅이다.
		 객체는 항상 업캐스팅 할 수 있으므로 명시적으로 적어주지 않아도 자바가 대신해준다.
		 하지만 객체 명시적으로 적어줘도 다운캐스팅 자체가 안될때가 있다.
		 ...
		 첫번째 human1 객체는 사람 클래스로 만들었기 때문에 여기는 사람의 공통된 속성과 기능들만
		 포함되어 있다. 그렇기 때문에 학생으로의 다운캐스팅은 불가능하다.
		 반면에 human2는 실제 학생() 생성자로 객체를 생성했으므로 객체 내부에는 사람의 공통된
		 특성뿐이 아니라 학생만의 속성과 기능들이 포함되어 있다. 따라서 human2도 사람 자료형으로
