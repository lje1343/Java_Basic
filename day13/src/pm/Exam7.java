...
public class Exam7 {
	...
	public static void main(String[] args) {
		...
		KeyValue<String, Void> kv3 = new KeyValue<>();	// 자리는 만들었지만 값은 안줬다.
		kv3.setKey("키값만 사용");
...
/*
 ...
 2. setter 메서드에 잘못된 객체를 입력했을 때 바로 문법으로 확인 할 수 있어야 하고
 3. getter 메서드의 리턴 타입도 다운캐스팅이 필요 없어야 한다는 것이다.
 
 1의 경우에는 Object 타입으로 선언을 통해 가능해지지만
 2/3의 경우까지 만족 시키기 위한 유일한 방법이 바로 제네릭이다.
