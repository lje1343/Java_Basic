...
public class Exam8 {
	...
	public static void main(String[] args) {
		...
		// 예를들면 3과 3은 같은 데이터이다. 즉, 2개 이상을 저장 할 수 없다.
		// A a1 = new A(3) 과 A a2 = new A(3) 생성자에 동일한 값을 넘겨서 객체를
		// 생성했으므로 두 객체는 완벽히 똑같다. 하지만 Set의 관점에서는 다른 객체이다.
		// 즉, 둘 다 저장할 수 있다.
		// 똑같은 예로 String s1 = new String("hi")
		// String s2 = new String("hi")
		
		// 해시코드 개념 - 객체의 해시코드는 객체가 저장된 주소와 관련된 값으로 실제 번지 값은 아니다.
		...
		System.out.println(c.equals(d)); // String은 꼭 equals를 쓰자
